...
pub(crate) struct WorkListSummaryV1<'a> {
    ...
    task_references_enabled_at: Option<&'a DateTime<Utc>>,
    current_task_reference_scheme_revision: Option<i64>,
    current_task_reference_scheme_revision_id: Option<Uuid>,
...
impl<'a> From<&'a AgentWorkListSummary> for WorkListSummaryV1<'a> {
    fn from(value: &'a AgentWorkListSummary) -> Self {
        Self {
            ...
            task_references_enabled_at: value.task_references_enabled_at.as_ref(),
            current_task_reference_scheme_revision: value.current_task_reference_scheme_revision,
            current_task_reference_scheme_revision_id: value
...
mod tests {
    ...
    fn explicit_task_v1_dto_preserves_the_published_shape() {
        ...
        let task = AgentTaskSummary {
            ...
            reference: Some("LAW-0031".to_string()),
