...
use worklist_client_auth::{
    AuthResponse, CompleteMfaLoginError, Credentials, LoginOutcome, PersistedDataKeyStatus,
    SecretMfaCode, UnlockMode, auth_response_to_credentials, begin_login, clear_credentials,
    complete_mfa_login, credentials_path, load_credentials, load_credentials_for_url, logout,
...
async fn cmd_login(
    ...
    let credentials = persist_final_auth_response(api_url, auth_response, save_credentials)?;
...
fn persist_final_auth_response(
    api_url: &str,
    auth_response: AuthResponse,
    persist: impl FnOnce(&Credentials) -> PublicResult<()>,
...
mod tests {
    ...
    #[test]
    fn login_stdin_accepts_password_only() {
    ...
    #[test]
    fn login_stdin_preserves_the_optional_factor_line_exactly() {
    ...
    #[test]
    fn login_stdin_secret_container_zeroizes_on_drop() {
    ...
    #[test]
    fn credentials_are_persisted_only_from_a_final_auth_response() {
    ...
    #[test]
    fn login_does_not_wait_to_or_beyond_the_mfa_deadline() {
    ...
    #[test]
    fn login_does_not_prompt_after_the_mfa_attempt_budget_is_exhausted() {
    ...
    #[test]
    fn login_stdin_rejects_additional_nonempty_lines() {
    ...
    #[test]
    fn non_login_password_stdin_keeps_whole_trimmed_input_contract() {
